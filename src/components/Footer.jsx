...
function Footer() {
  ...
  //         (data) => data.name.common === "India"
  //       );
  //       console.log("default", defaultCountry);

  //       setDefaultData({
  //         value: defaultCountry.name.common,
  //         label: (
  //           <div className="flex text-white gap-2">
  //             <img
  //               className="h-[20px] w-[20px]"
  //               src={defaultCountry.flags.png}
  //               alt={defaultCountry.name.common}
  //             />
  //             <p>INR</p>
  //           </div>
  //         ),
  //       });
  //       console.log("dar", defaultData);
  //     } else {
  ...
  //   value: { data: data.name.common },
  //   label: (
  //     <div className="felx justify-center text-black gap-2">
  //       <img
  //         className="h-[20px] w-[20px]"
  //         src={data?.flags?.png}
  ...
  //     border: "none",
  //     width: "auto", // Width of the Select component
  //   }),
  //   menu: (provided) => ({
  //     ...provided,
  //     width: "200px", // Set the width of the dropdown menu
  //     position: "relative", // Ensure dropdown doesn’t push other content
  //     zIndex: 10, // Ensure it stays on top of other elements
  //   }),
  //   menuList: (provided) => ({
  //     ...provided,
  //     padding: 0,
  //     position: "absolute", // Remove padding to ensure the list fits within the width
  //   }),
