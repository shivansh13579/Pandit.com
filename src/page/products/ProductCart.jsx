      ...
      {isAboveScreen ? (
        <>
          {cart && cart.length > 0 ? (
                ...
                <table className="col-span-8 mr-2">
                  <thead className="flex justify-between items-center w-full">
                    <tr className="w-full flex justify-between items-center pb-2">
                      ...
                      <th className="basis-1/4 text-center text-xl">
                        Quantity
                      </th>
            ...
            <>
              <div className="flex items-center justify-center py-5 w-5/6 mx-auto bg-gray-300 my-4 rounded-xl">
                <h1 className="text-4xl font-bold text-red-600 w-full text-center ">
                  Cart Is Empty
                </h1>
              </div>
            </>
